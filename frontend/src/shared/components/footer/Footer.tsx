...
export const Footer = () => {
  return (
    <footer className="bg-[#0b1220] border-t border-[#1b2a44] text-gray-200" style={{ boxShadow: "0px -12px 16px -7px rgb(25 36 59)" }}>
        ...
        <div>
          ...
          <ul className="space-y-2 pl-0 text-sm list-inside">
            ...
            <li className="flex items-center space-x-3">
              ...
              <a href="/terms-and-conditions" className="hover:text-[#2fd07f]">
                Terms & Conditions
              </a>
            </li>
            <li className="flex items-center space-x-3">
              {/* No cookie icon in Heroicons, can use document or gift icon or replace with other icon set */}
              <HiOutlineDocumentText className="text-[#2fd07f] w-5 h-5" />
